...
E.mix( E.prototype, {
	...
	clone : function( dataAndEvents, deepDataAndEvents ){
		...
		var elems = this.map(function(){
			return easyNode.clone( this, dataAndEvents, deepDataAndEvents );
		});
	...
	text : function( text ){
		...
		if( E.isFunction(text) ){
			return this.forEach(function( i ){
				var elem = E( this );
				elem.text( text.call(this, i, elem.text()) );
				elem = null;
			});
		}
	},
	...
	html : function( content ){
		...
		else if( E.isFunction(content) ){
			this.forEach(function( i ){
				var elem = E( this );
				elem.html( content.call(this, i, elem.html()) );
			});
		}
		else{
			this.empty().append( content );
...
E.mix( E.prototype, {
	...
	addClass : function( name ){
		...
		if( E.isFunction(name) ){
			return this.forEach(function( i ){
				E( this ).addClass( name.call(this, i, this.className) );
			});
		}
	},
	...
	removeClass : function( name ){		
		...
		if( E.isFunction(name) ){
			return this.forEach(function( i ){
				E( this ).removeClass( name.call(this, i, this.className) );
			});			
		}
	...
	toggleClass : function( name ){
		...
		if( E.isFunction(name) ){
			return this.forEach(function( i ){
				E( this ).toggleClass( name.call(this, i, this.className) );
			});			
		}		
	},
	...
	val : function( value ){
		...
		// setValue
		var isFunction = E.isFunction( value );		
		return this.forEach(function( i ){
			elem = E( this );
